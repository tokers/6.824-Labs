...
(cd .. && go build $RACE github.com/tokers/6.824-labs/lab1/cmd/mrmaster) || exit 1
(cd .. && go build $RACE github.com/tokers/6.824-labs/lab1/cmd/mrworker) || exit 1
(cd .. && go build $RACE github.com/tokers/6.824-labs/lab1/cmd/mrsequential) || exit 1
...
timeout -k 2s 180s ../mrmaster ../testdata/pg*txt &
...
rm -f mr-done
(timeout -k 2s 180s ../mrmaster ../testdata/pg*txt ; touch mr-done ) &
sleep 1
